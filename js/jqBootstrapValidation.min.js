...
a,g.jqBootstrapValidation("collectErrors",!0))):(c.removeClass("error"),e.isFunction(b.options.submitSuccess)&&b.options.submitSuccess(c,a))});return this.each(function(){var a=e(this),c=a.parents(".form-group").first(),f=c.find(".help-block").first(),g=a.parents("form").first(),h=[];!f.length&&b.options.autoAdd&&b.options.autoAdd.helpBlocks&&(f=e('<div class="help-block" />'),c.find(".controls").append(f),q.push(f[0]));if(b.options.sniffHtml){var d="";void 0!==a.attr("pattern")&&(d="Not in the expected format\x3c!-- data-validation-pattern-message to override --\x3e",
a.data("validationPatternMessage")&&(d=a.data("validationPatternMessage")),a.data("validationPatternMessage",d),a.data("validationPatternRegex",a.attr("pattern")));if(void 0!==a.attr("max")||void 0!==a.attr("aria-valuemax")){var k=void 0!==a.attr("max")?a.attr("max"):a.attr("aria-valuemax");d="Too high: Maximum of '"+k+"'\x3c!-- data-validation-max-message to override --\x3e";a.data("validationMaxMessage")&&(d=a.data("validationMaxMessage"));a.data("validationMaxMessage",d);a.data("validationMaxMax",
k)}if(void 0!==a.attr("min")||void 0!==a.attr("aria-valuemin"))k=void 0!==a.attr("min")?a.attr("min"):a.attr("aria-valuemin"),d="Too low: Minimum of '"+k+"'\x3c!-- data-validation-min-message to override --\x3e",a.data("validationMinMessage")&&(d=a.data("validationMinMessage")),a.data("validationMinMessage",d),a.data("validationMinMin",k);void 0!==a.attr("maxlength")&&(d="Too long: Maximum of '"+a.attr("maxlength")+"' characters\x3c!-- data-validation-maxlength-message to override --\x3e",a.data("validationMaxlengthMessage")&&
...
a.attr("minchecked")));void 0!==a.attr("maxchecked")&&(d="Too many options checked; Maximum of '"+a.attr("maxchecked")+"' required\x3c!-- data-validation-maxchecked-message to override --\x3e",a.data("validationMaxcheckedMessage")&&(d=a.data("validationMaxcheckedMessage")),a.data("validationMaxcheckedMessage",d),a.data("validationMaxcheckedMaxchecked",a.attr("maxchecked")))}void 0!==a.data("validation")&&(h=a.data("validation").split(","));e.each(a.data(),function(a,c){var b=a.replace(/([A-Z])/g,
",$1").split(",");"validation"===b[0]&&b[1]&&h.push(b[1])});d=h;var p=[];do e.each(h,function(a,b){h[a]=n(b)}),h=e.unique(h),p=[],e.each(d,function(c,d){if(void 0!==a.data("validation"+d+"Shortcut"))e.each(a.data("validation"+d+"Shortcut").split(","),function(a,b){p.push(b)});else if(b.builtInValidators[d.toLowerCase()]){var f=b.builtInValidators[d.toLowerCase()];"shortcut"===f.type.toLowerCase()&&e.each(f.shortcut.split(","),function(a,b){b=n(b);p.push(b);h.push(b)})}}),d=p;while(0<d.length);var l=
...
m&&(k.message=f);var h=k.type.toLowerCase();"shortcut"===h?g=!0:e.each(b.validatorTypes,function(b,c){void 0===l[b]&&(l[b]=[]);g||h!==b.toLowerCase()||(a.data("validation"+d+n(c.name),k[c.name.toLowerCase()]),l[h].push(e.extend(k,c.init(a,d))),g=!0)})}g||e.error("Cannot find validation info for '"+d+"'")});f.data("original-contents",f.data("original-contents")?f.data("original-contents"):f.html());f.data("original-role",f.data("original-role")?f.data("original-role"):f.attr("role"));c.data("original-classes",
c.data("original-clases")?c.data("original-classes"):c.attr("class"));a.data("original-aria-invalid",a.data("original-aria-invalid")?a.data("original-aria-invalid"):a.attr("aria-invalid"));a.bind("validation.validation",function(c,d){var f=r(a),g=[];e.each(l,function(c,m){(f||f.length||d&&d.includeEmpty||b.validatorTypes[c].blockSubmit&&d&&d.submitting)&&e.each(m,function(d,e){b.validatorTypes[c].validate(a,f,e)&&g.push(e.message)})});return g});a.bind("getValidators.validation",function(){return l});
a.bind("submit.validation",function(){return a.triggerHandler("change.validation",{submitting:!0})});a.bind("keyup focus blur click keydown keypress change".split(" ").join(".validation ")+".validation",function(d,m){var k=r(a),h=[];c.find("input,textarea,select").each(function(b,c){var d=h.length;e.each(e(c).triggerHandler("validation.validation",m),function(a,b){h.push(b)});h.length>d?e(c).attr("aria-invalid","true"):(d=a.data("original-aria-invalid"),e(c).attr("aria-invalid",void 0!==d?d:!1))});
g.find("input,select,textarea").not(a).not('[name="'+a.attr("name")+'"]').trigger("validationLostFocus.validation");h=e.unique(h.sort());h.length?(c.removeClass("success error").addClass("warning"),b.options.semanticallyStrict&&1===h.length?f.html(h[0]+(b.options.prependExistingHelpBlock?f.data("original-contents"):"")):f.html('<ul role="alert"><li>'+h.join("</li><li>")+"</li></ul>"+(b.options.prependExistingHelpBlock?f.data("original-contents"):""))):(c.removeClass("warning error success"),0<k.length&&
...
-1<q.indexOf(a[0])&&a.remove()})},collectErrors:function(c){var b={};this.each(function(a,c){var f=e(c),g=f.attr("name");f=f.triggerHandler("validation.validation",{includeEmpty:!0});b[g]=e.extend(!0,f,b[g])});e.each(b,function(a,c){0===c.length&&delete b[a]});return b},hasErrors:function(){var c=[];this.each(function(b,a){c=c.concat(e(a).triggerHandler("getValidators.validation")?e(a).triggerHandler("validation.validation",{submitting:!0}):[])});return 0<c.length},override:function(c){k=e.extend(!0,
k,c)}},validatorTypes:{callback:{name:"callback",init:function(c,b){return{validatorName:b,callback:c.data("validation"+b+"Callback"),lastValue:c.val(),lastValid:!0,lastFinished:!0}},validate:function(c,b,a){if(a.lastValue===b&&a.lastFinished)return!a.lastValid;!0===a.lastFinished&&(a.lastValue=b,a.lastValid=!0,a.lastFinished=!1,t(a.callback,window,c,b,function(b){a.lastValue===b.value&&(a.lastValid=b.valid,b.message&&(a.message=b.message),a.lastFinished=!0,c.data("validation"+a.validatorName+"Message",
...
checkone:{name:"Checkone",type:"minchecked",minchecked:1,message:"Check at least one option\x3c!-- data-validation-checkone-message to override --\x3e"}}},n=function(c){return c.toLowerCase().replace(/(^|\s)([a-z])/g,function(b,a,c){return a+c.toUpperCase()})},r=function(c){var b=c.val(),a=c.attr("type");"checkbox"===a&&(b=c.is(":checked")?b:"");"radio"===a&&(b=0<e('input[name="'+c.attr("name")+'"]:checked').length?b:"");return b};e.fn.jqBootstrapValidation=function(c){return k.methods[c]?k.methods[c].apply(this,
Array.prototype.slice.call(arguments,1)):"object"!==typeof c&&c?(e.error("Method "+c+" does not exist on jQuery.jqBootstrapValidation"),null):k.methods.init.apply(this,arguments)};e.jqBootstrapValidation=function(c){e(":input").not("[type=image],[type=submit]").jqBootstrapValidation.apply(this,arguments)}})(jQuery);