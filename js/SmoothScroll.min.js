...
a||r.y!==b)r.x=a,r.y=b,q=[],v=0}function x(a,b){return Math.floor(a/b)==a/b}function E(a){a*=f.pulseScale;if(1>a)var b=a-(1-Math.exp(-a));else b=Math.exp(-1),a=1-Math.exp(-(a-1)),b+=a*(1-b);return b*f.pulseNormalize}var u={frameRate:150,animationTime:400,stepSize:120,pulseAlgorithm:!0,pulseScale:8,pulseNormalize:1,accelerationDelta:20,accelerationMax:1,keyboardSupport:!0,arrowScroll:50,touchpadSupport:!0,fixedBackground:!0,excluded:""},f=u,C=!1,r={x:0,y:0},B=!1,k=document.documentElement,l,h=[120,
